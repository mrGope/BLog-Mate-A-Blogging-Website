    ...
    <div className="container">
            {
                dataList?.map((story, storyIndex) => {
                    if(storyIndex%2===0 && (filterEmail===false && story.storyTitle.toLowerCase().includes(filterName.toLowerCase()) ||story.storyDescription.toLowerCase().includes(filterName.toLowerCase()) ) || (filterEmail===true && story.userEmail.includes(userEmail) && story.storyTitle.includes(filterName))) {
                        return (    
